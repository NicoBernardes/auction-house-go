...
import (
	...
	"github.com/NicoBernardes/auction-house-go.git/internal/validator"
...
func (req CreateProductReq) Valid(ctx context.Context) validator.Evaluator {
	...
	eval.CheckField(validator.MinChars(req.Description, 10) && validator.MaxChars(req.Description, 255),
